...
async function main() {
  ...
  await prisma.sideLabel.deleteMany();
  await prisma.littleIconLabel.deleteMany();
  await prisma.merchantBrief.deleteMany();
  await prisma.estimatedDeliveryFee.deleteMany();
  await prisma.merchantStatusInfo.deleteMany();
          ...
          create: {
            ...
            openHours: merchant.merchantBrief.openHours
              ? {
                  create: {
                    ...
                    displayedHours:
                      merchant.merchantBrief.openHours.displayedHours || "",
            ...
            displayInfo: merchant.merchantBrief.displayInfo
              ? {
                  create: {
                    primaryText:
                      merchant.merchantBrief.displayInfo.primaryText || "",
                  },
                }
              : undefined,
    ...
    estimatedDeliveryFee: merchant.estimatedDeliveryFee
      ? {
          create: {
            ...
            currencyExponent:
              merchant.estimatedDeliveryFee.currency.exponent || 0,
            ...
            priceDisplayHtml:
              merchant.estimatedDeliveryFee.priceDisplayHtml || "",
            hasDiscountedPrice:
              merchant.estimatedDeliveryFee.hasDiscountedPrice || false,
          },
        }
      : undefined,
